...
// 	ctx                    context.Context
// 	blkNotificationService *notification.NotificationService
// }

// func NewNotificationBatchWorker(dbConn *gorm.DB, rbmqConn *rbmq.Connection, ctx context.Context, blkNotificationService *notification.NotificationService) *NotificationBatchWorker {
