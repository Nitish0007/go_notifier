...
// 	notificationBatchRepo *NotificationBatchRepository
// 	notificationBatchErrorRepo *NotificationBatchErrorRepo
// }

// func NewBulkNotificationService(nr *NotificationRepository, nbr *NotificationBatchRepository, nber *NotificationBatchErrorRepo) *BulkNotificationService {
...
// 	nChannel, err := StringToNotificationChannel(notificationsList[0]["channel"].(string))
// 	if err != nil {
// 		return nil, err
// 	}
